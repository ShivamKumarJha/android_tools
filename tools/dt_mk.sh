...
bash $PROJECT_DIR/tools/writemk.sh "\$(LOCAL_PATH)/configs/audio/" ":\$(TARGET_COPY_OUT_VENDOR)/etc/" "# Audio"
...
bash $PROJECT_DIR/tools/writemk.sh "\$(LOCAL_PATH)/configs/media/" ":\$(TARGET_COPY_OUT_VENDOR)/etc/" "# Media"
find ""$DT_DIR"/configs/seccomp/" -type f -printf '%P\n' | sort > "$PROJECT_DIR"/working/mklist.txt
bash $PROJECT_DIR/tools/writemk.sh "\$(LOCAL_PATH)/configs/seccomp/" ":\$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/" "# Seccomp"
find ""$DT_DIR"/configs/sensors/" -type f -printf '%P\n' | sort > "$PROJECT_DIR"/working/mklist.txt
bash $PROJECT_DIR/tools/writemk.sh "\$(LOCAL_PATH)/configs/sensors/" ":\$(TARGET_COPY_OUT_VENDOR)/etc/sensors/" "# Sensors"
