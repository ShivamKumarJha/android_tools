...
# ADSP modules
cat $PROJECT_DIR/working/rom_all.txt | grep "vendor/lib/rfsa/adsp/" | grep -v "scve" | sort -u >> $PROJECT_DIR/working/proprietary/ADSP-Modules
...
cat $PROJECT_DIR/working/rom_all.txt | grep -iE "vendor/etc/camera/|vendor/etc/qvr/|vendor/camera3rd/" | sort -u >> $PROJECT_DIR/working/proprietary/Camera-configs
...
cat $PROJECT_DIR/working/rom_all.txt | grep "vendor/" | grep -iE "libremosaic|lib/camera/|lib64/camera/|libcamx|libcamera|mibokeh" | grep -v "vendor/lib/rfsa/adsp/" | sort -u >> $PROJECT_DIR/working/proprietary/Camera
...
# Sensors
cat $PROJECT_DIR/working/rom_all.txt | grep "vendor/" | grep -iE "libsensor|lib64/sensors|lib/sensors" | sort -u >> $PROJECT_DIR/working/proprietary/Sensors
...
# Vivo
cat $PROJECT_DIR/working/rom_all.txt | grep "vendor/" | grep -iE "vivo.hardware|hardware.vivoem|vivo_|libc.vivo|libvivo|_vivo" | sort -u >> $PROJECT_DIR/working/proprietary/Vivo
...
# Xiaomi
cat $PROJECT_DIR/working/rom_all.txt | grep "vendor/" | grep -iE "xiaomi" | grep -v "camera" | grep -v "vendor/etc/nuance/" | sort -u >> $PROJECT_DIR/working/proprietary/Xiaomi
